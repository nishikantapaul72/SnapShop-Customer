            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                ...
                {cart.map((item) => (
                  <div
                    key={item.id}
                    className="border-b py-6 grid grid-cols-1 md:grid-cols-12 items-center"
                  >
                    ...
                    <div className="col-span-2 text-center">
                      <p className="md:hidden font-medium inline-block mr-2">
                        Price:
                      </p>
                      ${item.price}
                    </div>
                ...
                <div className="flex justify-between mt-10">
                  ...
                  <button className="border border-gray-300 px-6 py-2 rounded-md hover:bg-gray-50 cursor-pointer">
                    Update Cart
                  </button>
                </div>
              </div>
              ...
              <div className="lg:col-span-1">
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="flex justify-center mt-6">
                    <button
                      className="bg-[#e74c3c] text-white w-full py-3 rounded-md hover:bg-[#c0392b] cursor-pointer"
